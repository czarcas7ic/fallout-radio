...
class AudioPlayer:
    ...
    def __init__(self, sounds_dir: Optional[Path] = None):
        ...
        self._loudness_normalization: bool = False  # EBU R128 loudness normalization
    ...
    def play_url(self, url: str, start_position: float = 0, stop_current: bool = True) -> bool:
        ...
        # Loudness normalization - keeps volume consistent across stations
        if self._loudness_normalization:
            cmd.append("--af=lavfi=[loudnorm=I=-16:TP=-1.5:LRA=11]")
